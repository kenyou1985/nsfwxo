...
const R18_SIX_SEGMENT_TEMPLATES = [
  ...
  // Segment 5: 高潮性爱 - 5种射精方式之一作为唯一射精（只能有1次射精）
  {
    segment: 'peak_sex',
    description: '场景高潮展现强烈的高潮瞬间。角色阴道剧烈痉挛达到高潮，全身颤抖尖叫，眼神上翻背部拱起，阴道紧紧裹住阴茎。男性低吼着加速抽插，角色在极限高潮中急促喘息，皮肤潮红。高潮余韵中持续抽插，身体痉挛。男性选择以下任意1种方式完成射精（全程唯一1次射精）：口爆（精液射入女性口腔/面部，她张嘴接受并舔食吞下）；体内射精（男性在阴道最深处射出浓稠精液形成体内射精creampie）；射胸部（精液射在女性乳房/胸部/腹部上，男性低吼）；后入特写臀部（背部深弓臀部高举时精液从交合处溢出，镜头从后方捕捉插入与臀部闪烁）；射臀部（精液射在女性臀部/腰窝/臀瓣上）。严禁出现2次或多次射精。',
    framing: '亲密极限特写捕捉高潮痉挛、唯一射精动作和高峰高潮表情',
    audio: '达到最大音量的强烈呻吟，激情感叹声，湿润的声音，最终释放声',
  },
  // Segment 6: 收尾 - 激情收尾、情感余韵（承接唯一的射精结果，不含新射精动作）
  {
    segment: 'conclusion',
    description: '场景收尾，角色衣衫不整半裸或全裸，身体残留射精痕迹，精液从嘴角、下巴、乳房、私密部位或臀部等处可见。她坐或躺在原位微微喘息，眼神餍足回眸看向镜头。动作流畅，60fps，无肢体畸形，正确人体解剖，五指完整，双腿完整，面部特征一致，无抖动，无跳帧，流畅连续动作。',
    framing: '中景镜头捕捉事后状态和完全满足感',
